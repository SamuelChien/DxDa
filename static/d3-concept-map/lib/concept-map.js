...
// w - delay on initial elastic jump
// U - width of document recetangle
// K - height of document rectangle

console.log(dataJson)
var a=500,c=500,h=c,U=150,K=22,S=20,s=8,R=110,J=30,o=15,t=10,w=5000,F="elastic",N="#0da4d3";
var T,q,x,j,H,A,P;
var L={},k={};
var i,y;
...
function O(){
	...
	y=Math.floor(T.get("ditems").length*i/2 - i/2);
	console.log("y =", y)
